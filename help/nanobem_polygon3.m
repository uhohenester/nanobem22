%% The polygon3 class
%
% The polygon3 class builds upon the <nanobem_polygon.html polygon> and
% <nanobem_edgeprofile.html edgeprofile> classes and allows to extrude 2D
% polygons.
%
%% Initialization
...
plot( union( up, ribbon, lo, p ) );
%  plot particles separately
plot( union(  ...
  shift( up, [ 20, 0, 0 ] ), shift( ribbon, [ 30, 0, 0 ] ),   ...
...
%  plot ribbons
plot( union( rib1, rib2, shift( rib3, [ 40, 0, 0 ] ), shift( rib4, [ 70, 0, 0 ] ) ), 'EdgeColor', 'b' );

%%
% <<../figures/polyparticle2.png>>
%
