%% The polygon class
%
% Metallic and dielectric nanoparticles are often fabricated by means of
% electron beam lithography.  These particles can have a complicated shape
% in a 2D plane while the shape in the third direction comes from some kind
% of extrusion. To deal with such particles we have introduced the polygon
% class that allows for a flexible design of polygons in 2D together with a
% number of functions to extrude the polygon into the z-direction.  The
% polygon class uses the Mesh2D toolbox avaialble at
% <http://www.mathworks.com www.mathworks.com>.  To access the functions of
% the Mesh2D toolobox one must add the Mesh2D directory name to the Matlab
% paths.
%
%% Initialization
...
poly = rot(  poly, angle );         
%  flip polygon along give direction
poly = flip( poly, dir );
...
% <nanobem_polygon3.html polygon3> section.
%
%%
%
